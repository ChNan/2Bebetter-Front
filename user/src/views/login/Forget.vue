    ...
    <div class="s-bg">
        ...
        <div class="m-container">
            <div class="m-wrap">
                ...
                <el-form :model="forgetForm" :rules="rules" ref="forgetForm">
                    <el-form-item prop="username" :error="errors.backend">
                        <el-input size="large" :placeholder="$t('login.account')" v-model="forgetForm.username" :maxlength="128"></el-input>
                    </el-form-item>
                    <el-form-item prop="email">
                        <el-input size="large" :placeholder="$t('forget.email')" v-model="forgetForm.email" :maxlength="128"></el-input>
                    </el-form-item>
                    ...
                    <router-link :to="{name:'/meeting/login'}" class="u-back">{{$t("forget.back")}}</router-link>
                </el-form>
            </div>
        </div>
        <div class="m-footer">
        ...
        <el-dialog title="" :visible.sync="dialogVisible" size="tiny" :show-close="false" :close-on-click-modal="false" :close-on-press-escape="false" custom-class="wd400 forget">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="toLogin" type="primary">{{$t("activate.back")}}</el-button>
            </span>
        </el-dialog>
    </div>
</template>
