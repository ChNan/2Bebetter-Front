...
// 首页3个会议的获取
export const threeConference = (params, show, type) => {
    return _axios.post('conferenceRecord/getPagedList', params, show, type)
};

// 获取正在进行的会议数
export const countByStaff = (params, show, type) =>{
    return _axios.get("confOngoing/countByStaff" , params, show, type).then(res => res.data)
};
